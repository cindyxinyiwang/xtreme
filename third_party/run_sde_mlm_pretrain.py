...
from processors.utils import convert_examples_to_sde_features
...
def load_and_cache_examples(args, task, tokenizer, split='train', language='en', lang2id=None, evaluate=False):
  ...
  cached_features_file = os.path.join(
    args.data_dir, "cached_sde_bpeseg{}_ngram{}_{}_{}_{}_{}".format(args.bpe_segment, args.max_ngram_size, split, 
