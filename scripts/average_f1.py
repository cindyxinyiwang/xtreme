...
def qa_results(filename):
  ...
  print(combined_df)
  print("ave f1 over random seeds:", combined_df.xs('f1').mean(axis=1).mean())
  print("ave exact f1 over random seeds:", combined_df.xs('exact f1').mean(axis=1).mean())
