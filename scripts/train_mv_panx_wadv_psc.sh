...
OUTPUT_DIR="$OUT_DIR/$TASK/${MODEL}-LR${LR}-epoch${NUM_EPOCHS}-MaxLen${MAX_LENGTH}-TrainLang${TRAIN_LANGS}_mbped${BPE_DROP}_wadv_lr${ALR}_as${ASTEP}_an${ANORM}_am${AMAG}_at${AT}_ad${AD}_kl${KL}_s${SEED}/"
